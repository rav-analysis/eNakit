...
namespace Microsoft.eShopWeb.FunctionalTests.Web.Controllers
{
    ...
    public class AuthenticateEndpoint : IClassFixture<ApiTestFixture>
    {
        ...
        [Theory]
        [InlineData("testdemo@gmail.com", AuthorizationConstants.DEFAULT_PASSWORD, true)]
        [InlineData("testdemo@gmail.com", "badpassword", false)]
        [InlineData("baduser@gmail.com", "badpassword", false)]
